...
export const gamificationTrendsByRange: Record<string, TrendDataset> = {
  ...
  "1m": buildTrendDataset(
    ...
    [
      { label: "Participation Rate", color: "#007AFF", data: [84, 71, 89, 86] },
      { label: "Completion Rate", color: "#34C759", data: [68, 52, 76, 72] },
      { label: "Repeat Attempts", color: "#FF9F0A", data: [31, 43, 24, 28] },
    ],
  ),
  "1s": buildTrendDataset(
    ...
    [
      { label: "Participation Rate", color: "#007AFF", data: [62, 78, 71, 83] },
      { label: "Completion Rate", color: "#34C759", data: [45, 61, 53, 70] },
      { label: "Repeat Attempts", color: "#FF9F0A", data: [19, 27, 36, 23] },
    ],
  ),
  "1y": buildTrendDataset(
    ...
    [
      { label: "Participation Rate", color: "#007AFF", data: [57, 74, 68, 81] },
      { label: "Completion Rate", color: "#34C759", data: [39, 58, 49, 66] },
      { label: "Repeat Attempts", color: "#FF9F0A", data: [15, 25, 33, 22] },
    ],
  ),
  all: buildTrendDataset(
    ...
    [
      { label: "Participation Rate", color: "#007AFF", data: [48, 53, 50, 61, 64, 59, 68, 72, 75, 81] },
      { label: "Completion Rate", color: "#34C759", data: [30, 34, 33, 42, 46, 43, 52, 57, 61, 66] },
      { label: "Repeat Attempts", color: "#FF9F0A", data: [11, 13, 15, 18, 20, 24, 28, 26, 30, 22] },
    ],
  ),
};
...
export const aiHintTrendsByRange: Record<string, TrendDataset> = {
  ...
  "1m": buildTrendDataset(
    ...
    [
      { label: "Hint Usage Rate", color: "#007AFF", data: [36, 44, 28, 33] },
      { label: "Post-Hint Solve Rate", color: "#34C759", data: [58, 49, 61, 57] },
      { label: "Attempts After Hint", color: "#FF9F0A", data: [18, 27, 14, 16] },
    ],
  ),
  "1s": buildTrendDataset(
    [
    ...
    [
      { label: "Hint Usage Rate", color: "#007AFF", data: [18, 29, 41, 26] },
      { label: "Post-Hint Solve Rate", color: "#34C759", data: [46, 55, 48, 60] },
      { label: "Attempts After Hint", color: "#FF9F0A", data: [11, 16, 24, 13] },
    ],
  ),
  "1y": buildTrendDataset(
    [
    ...
    [
      { label: "Hint Usage Rate", color: "#007AFF", data: [15, 27, 39, 25] },
      { label: "Post-Hint Solve Rate", color: "#34C759", data: [42, 53, 47, 58] },
      { label: "Attempts After Hint", color: "#FF9F0A", data: [9, 15, 22, 12] },
    ],
  ),
  all: buildTrendDataset(
    [
    ...
    [
      { label: "Hint Usage Rate", color: "#007AFF", data: [10, 13, 16, 21, 24, 31, 35, 33, 38, 29] },
      { label: "Post-Hint Solve Rate", color: "#34C759", data: [36, 39, 41, 46, 49, 53, 57, 55, 58, 60] },
      { label: "Attempts After Hint", color: "#FF9F0A", data: [6, 8, 9, 11, 13, 16, 19, 17, 20, 14] },
    ],
  ),
};
